...
import { OnTXCreatedListener } from "./btctxsocket/onTXCreatedListener"
...
export class BtcTXShooterGame implements OnTXCreatedListener{
    ...
    create() {
        this.game.world.setBounds(0,0,GameConfig.WORLD_WIDTH, GameConfig.WORLD_HEIGHT);
        this.game.physics.startSystem(Phaser.Physics.ARCADE);
        this.game.add.tileSprite(0, 0, GameConfig.WORLD_WIDTH, GameConfig.WORLD_HEIGHT, "space")
    ...
    public onTXCreated(satoshiAmount : number) : void {
        if (satoshiAmount < 10000) {
            ...
            this.asteroidGenerator.createAsteroid(Asteroid.ASTEROID_MEDIUM);
        } else {
            this.asteroidGenerator.createAsteroid(Asteroid.ASTEROID_LARGE);
        }
